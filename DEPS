...
deps = {
  ...
  'src/breakpad/src':
    (Var("git.chromium.org")) + '/external/google-breakpad/src.git@37be12b29358bfd130cbd82cc1468a4ca5265de9',
  'src/buildtools':
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@81bd89bf1741950b1ec75a92a02ace68a16a51d3',
  ...
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@40acdaeb86c516b68e3442f3a008e8d21e514bda',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/talk.git@b2811ad328c429a40b71642ca9ea9f426ee5ff9f',
  ...
  'src/third_party/libvpx':
    (Var("git.chromium.org")) + '/chromium/deps/libvpx.git@861f35b01c87a021540aace739cb7415c08e987b',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@41a5cc0c5bfcf998103180d33a2e32d2f495d656',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@bb821018349d16dca3a8ff4abfbf72817c2b22bc',
  ...
  'src/third_party/webrtc':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/webrtc.git@5727038f572c517204e1642b8bc69b25381c4e9f',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@74629a9084d6004e0ec5f06a2746e8f7210145e7'
}
