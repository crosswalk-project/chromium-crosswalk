...
deps_os = {
  ...
  'ios': {
    ...
    'src/third_party/WebKit/public':
      (Var("blink")) + '/branches/chromium/2062/public@178111',
    ...
    'android': {
      ...
      'src/third_party/android_tools':
        (Var("git.chromium.org")) + '/android_tools.git@7e1a9d2fadc6d5aba62b235ffa9a15f3b4be06cb',
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2062@178111',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@282aa1e4ee2d9aa64d42cf5a7516399f028b582f',
  ...
  'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
    (Var("native_client")) + '/branches/2062/src/native_client/tests/prebuilt@13479',
