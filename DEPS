...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2125@182060',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@773a327b12f653c3bb0630fee1b3ba9629f5717e',
  ...
  'src/third_party/webrtc':
    (Var("webrtc")) + '/branches/38/webrtc@7177',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@bc75f36b04c8bab99bcecf8cdca16ecee3ac58ee',
  ...
  'src/third_party/snappy/src':
    (Var("snappy")) + '/trunk@80',
  'src/breakpad/src':
    (Var("git.chromium.org")) + '/external/google-breakpad/src.git@17f614cd8365f5b78577ffcc237300a970db9813',
