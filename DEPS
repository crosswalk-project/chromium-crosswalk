...
deps_os = {
  ...
  'ios': {
    ...
    'src/third_party/WebKit/public':
      (Var("blink")) + '/branches/chromium/2062/public@180122',
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2062@180122',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@0d78ac294f814a45380eb44b0bb4c01aae2cab01',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@75551cf9a7c65bcdb9f9fe44ac78ca15da37942e',
