...
deps = {
  ...
  'depot_tools':
    '/trunk/tools/depot_tools@295099',
  'src/breakpad/src':
    (Var("git.chromium.org")) + '/external/google-breakpad/src.git@9fcbe255a64d39295ad5f1f15c0b92db3da83c0f',
  'src/buildtools':
    (Var("git.chromium.org")) + '/chromium/buildtools.git@15f5fc6fdb1795e2b99f66e5bc6c01e9fb62b436',
  ...
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@660eb1e1c91349b53f0d60bbf9a92e31f4cf4e1d',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@4a69f692023b7a85e218aed38ed3acc72be1d76f',
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@9624e05860bddf03ea5138fa14f4fa7b4a1f2f57',
  'src/third_party/bidichecker':
    (Var("git.chromium.org")) + '/external/bidichecker/lib.git@97f2aa645b74c28c57eca56992235c79850fa9e0',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@68de407b5fc746c0fa82706dd897288d01c32930',
  ...
  'src/third_party/crashpad/crashpad':
    (Var("git.chromium.org")) + '/crashpad/crashpad.git@3d216f5516d78239e760e9378614aeed600c2c50',
  'src/third_party/dom_distiller_js/dist':
    (Var("git.chromium.org")) + '/external/github.com/chromium/dom-distiller-dist.git@aaa3e9a897b74b97b032d7c957f155cc2e19a186',
  'src/third_party/ffmpeg':
    (Var("git.chromium.org")) + '/chromium/third_party/ffmpeg.git@104f872faf2cd809cdada885a1e39be85e5b3316',
  ...
  'src/third_party/icu':
    (Var("git.chromium.org")) + '/chromium/deps/icu.git@f8c0e585b0a046d83d72b5d37356cb50d5b2031a',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/talk.git@b11169ae0f7935c6e57d307b9b4afef076c80cbf',
  ...
  'src/third_party/libvpx':
    (Var("git.chromium.org")) + '/chromium/deps/libvpx.git@e9830e14ed6d3422c803bf45e0f6ffec341d8666',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@f3fecc0c686418272e49c8d51da2cb12e80bd1a2',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@05f7d5cbd83ab30653c79d81dc9829a97b845e38',
  ...
  'src/third_party/webgl/src':
    (Var("git.chromium.org")) + '/external/khronosgroup/webgl.git@66dc43ded4472d20dda860acbf22a06e625ea86a',
  'src/third_party/webpagereplay':
    (Var("git.chromium.org")) + '/external/github.com/chromium/web-page-replay.git@0e5c45a7ca4a43d9b9451db380de4ac5a543d1de',
  'src/third_party/webrtc':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/webrtc.git@e361d8e8132a927b24b5bd595f9371b4a2caa572',
  ...
  'src/tools/swarming_client':
    (Var("git.chromium.org")) + '/external/swarming.client.git@f222001cc23c7cdb574bf4cfb447f65c94bc6da3',
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@3cc5b8241c97fe71e6d0015271b71d927c4f1f1f'
}
...
deps_os = {
  'android': {
    ...
    'src/third_party/android_tools':
      (Var("git.chromium.org")) + '/android_tools.git@0c03d3bfef2606a30c3ccec9f6856e6acb75c2fb',
  ...
  'unix': {
    ...
    'src/third_party/chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@7c430e16a7bb03040576f012b424fab89974fdd4',
    'src/third_party/cros_system_api':
      (Var("git.chromium.org")) + '/chromiumos/platform/system_api.git@60c18c40b9c92a3f15d0f8052403614c698b8483',
