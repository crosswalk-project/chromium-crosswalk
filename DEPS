vars = {
  'angle_revision':
    '99f075dade7cfb0b56e80a065de3218745e4c177',
  'boringssl_git':
  ...
  'nss_revision':
    'bb4e75a43d007518ae7d618665ea2f25b0c60b63',
  'openmax_dl_revision':
    '0b238cb62c32b6f45680cf577eddb1b051ae0219',
  'pdfium_git':
    'https://pdfium.googlesource.com',
  'pdfium_revision':
    'e3dd159edee8cf2eec3f30f77ef6830597c1bc2f',
  'sfntly_revision':
    '1bdaae8fc788a5ac8936d68bf24f37d977a13dac',
  'skia_git':
    'https://skia.googlesource.com',
  'skia_revision':
    'aa4c7a704289b7adcbfbd23580667a1950a9ca6e',
  'sourceforge_url':
    'http://svn.code.sf.net/p/%(repo)s/code',
  'swarming_revision':
    '13e7c88b5a9494467259603486f001694ea85721',
  'v8_branch':
    'trunk',
  'v8_revision':
    'f5c0a23a505616796a628d64f4ffe377d1fc4bcf',
  'webkit_revision':
    '54ac8d7272b177ae0d94ca8de98bd236c7b8dbea',
  'webkit_trunk':
...
deps = {
  ...
  'src/third_party/libjingle/source/talk':
    (Var("chromium_git")) + '/external/webrtc/trunk/talk.git@2cb8e9c251330d6886134955158aceaec53c2dad',
  ...
  'src/third_party/libvpx':
    (Var("chromium_git")) + '/chromium/deps/libvpx.git@ea4ce75ca4525ad42dd90b2a210f99bd2b3a7c03',
  'src/third_party/libyuv':
    (Var("chromium_git")) + '/external/libyuv.git@d204db647e591ccf0e2589236ecea90330d65a66',
  'src/third_party/mesa/src':
    (Var("chromium_git")) + '/chromium/deps/mesa.git@071d25db04c23821a12a8b260ab9d96a097402f0',
  'src/third_party/openmax_dl':
    (Var("chromium_git")) + '/external/webrtc/deps/third_party/openmax.git@0b238cb62c32b6f45680cf577eddb1b051ae0219',
  'src/third_party/opus/src':
    (Var("chromium_git")) + '/chromium/deps/opus.git@cae696156f1e60006e39821e79a1811ae1933c69',
  'src/third_party/pdfium':
    (Var("pdfium_git")) + '/pdfium.git@e3471ff2929949f46004a8d55762d2e7d259b6c4',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@0528a0544e300cfce85fe14c22f7fc22dee0e116',
...
deps_os = {
  'android': {
    ...
    'src/third_party/lss':
      (Var("chromium_git")) + '/external/linux-syscall-support/lss.git@e079768b7e3a94dcbe7d338496c0c3bde7151b6e',
  ...
  'ios': {
    ...
    'src/third_party/nss':
      (Var("chromium_git")) + '/chromium/deps/nss.git@d1edb68688b91a380fb2025b3420fad68db54ed6',
  ...
  'mac': {
    ...
    'src/third_party/nss':
      (Var("chromium_git")) + '/chromium/deps/nss.git@bb4e75a43d007518ae7d618665ea2f25b0c60b63',
  ...
  'unix': {
    ...
    'src/third_party/pyelftools':
      (Var("chromiumos_git")) + '/third_party/pyelftools.git@19b3e610c86fcadb837d252c794cb5e8008826ae',
