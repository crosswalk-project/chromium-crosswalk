...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2125@180678',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@5a246bb48708cfdbf5b63f8df7e2b09b3704cae4',
  ...
  'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
    (Var("native_client")) + '/trunk/src/native_client/tests/prebuilt@13626',
  ...
  'src/third_party/ffmpeg':
    (Var("git.chromium.org")) + '/chromium/third_party/ffmpeg.git@5961d8ac36f995dc3162aff7f8039ef7d772aaac',
  'build':
  ...
  'src/v8':
    (Var("v8")) + '/branches/3.28@23153',
  'src/third_party/pywebsocket/src':
    (Var("pywebsocket")) + '/trunk/src@790',
  'src/third_party/libvpx':
    '/trunk/deps/third_party/libvpx@289332',
