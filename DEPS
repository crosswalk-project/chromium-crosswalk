...
deps_os = {
  ...
  'ios': {
    ...
    'src/tools/gyp':
      (Var("git.chromium.org")) + '/external/gyp.git@fe00999dfaee449d3465a9316778434884da4fa7',
  ...
  'unix': {
    ...
    'src/third_party/chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@c1bb274a82c13f76c3d8560808423605bfd84d76',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@293595',
  ...
  'src/third_party/openmax_dl':
    (Var("git.chromium.org")) + '/external/webrtc/deps/third_party/openmax.git@1a4171cedda887acc49408a8ea06bea740e74481',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@3b4b66c04a2567c72754a55e53db41394249b223',
  ...
  'src/third_party/webgl/src':
    (Var("git.chromium.org")) + '/external/khronosgroup/webgl.git@cff04f76d09ab148bf79361ed7bd8f8d8ee74761',
  'src/testing/gmock':
  ...
  'src/third_party/webrtc':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/webrtc.git@f35d62d1afd205dfaf54a7de93ac5c753f2c52cc',
  ...
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@57cd0f2bac7fedefd895f521f08f557918bceb91',
  ...
  'build':
    '/trunk/tools/build@293597',
  'src/tools/gyp':
    (Var("git.chromium.org")) + '/external/gyp.git@82b08049cc0b1f9e0bdcc0702ac6b523360f635f',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@04184fb0465ea2692b90cf0fa8b203df6c31cebf',
  'build/third_party/lighttpd':
    '/trunk/deps/third_party/lighttpd@58968',
  'src/buildtools':
    (Var("git.chromium.org")) + '/chromium/buildtools.git@451dcd05a5b34936f5be67b2472cd63aaa508401',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/talk.git@b40ea517179d49b2a39084ab05aaae85600bfbc2',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@f8105c665856863ad95da37fee6c12b98b953e2c',
  ...
  'src/third_party/trace-viewer':
    (Var("git.chromium.org")) + '/external/trace-viewer.git@2a348ed4cbdf27a8c9f0431d34ecbabf66182f08',
  ...
  'src/third_party/ffmpeg':
    (Var("git.chromium.org")) + '/chromium/third_party/ffmpeg.git@6693b7d53e41e08fcbd7da34005826dd560a4c01',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@0c6183254cdc03cd24e2a7621b99b89766977ac0',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@f28d8be2fa7875b4aa5f1df45bd9613425c3c35b',
  'src/third_party/pywebsocket/src':
    (Var("git.chromium.org")) + '/external/pywebsocket/src.git@cb349e87ddb30ff8d1fa1a89be39cec901f4a29c',
  'src/third_party/libvpx':
    (Var("git.chromium.org")) + '/chromium/deps/libvpx.git@d3f3dcefb055656807e8a2f65a322bbb13cd05a4',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@ca9a538aa0f2ebdd261783efa032e69a2ea17fbc',
