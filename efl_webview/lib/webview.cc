...
WebContentsDelegateXWalk::WebContentsDelegateXWalk(content::BrowserContext* browser_context)
{
...
WebView::WebView(Evas_Object* root_window)
  ...
  private_->webContentsDelegate.reset(new WebContentsDelegateXWalk(browser_context));
