...
TEST_F(UploadFileElementReaderTest, FileChanged_Negative) {
  base::File::Info info;
...
TEST_F(UploadFileElementReaderTest, FileChanged_Positive) {
  base::File::Info info;
  ASSERT_TRUE(base::GetFileInfo(temp_file_path_, &info));
...
TEST_F(UploadFileElementReaderTest, InexactExpectedTimeStamp_Negative) {
  base::File::Info info;
  ASSERT_TRUE(base::GetFileInfo(temp_file_path_, &info));
...
TEST_F(UploadFileElementReaderTest, InexactExpectedTimeStamp_Positive) {
  base::File::Info info;
  ASSERT_TRUE(base::GetFileInfo(temp_file_path_, &info));
